...
<head>
    ...
    <title>Ficha de Préstamo Interno | Biblioteca</title>
    <!-- Cargamos Tailwind CSS para un diseño moderno y rápido -->
    <script src="https://cdn.tailwindcss.com"></script>
    <style>
        /* Personalización sutil para la paleta del Jardín */
...
<body class="bg-stone-100 min-h-screen py-10">

    <div class="max-w-4xl mx-auto bg-white rounded-xl shadow-lg overflow-hidden">
        
        <!-- Encabezado -->
        <div class="bg-jardin text-white px-8 py-6 flex justify-between items-center">
            <div>
                <h1 class="text-2xl font-bold tracking-wide">JARDÍN ETNOBIOLÓGICO DE OAXACA</h1>
                <h2 class="text-lg font-light opacity-90">BIBLIOTECA</h2>
            </div>
            <div class="text-right">
                <span class="block text-sm font-semibold uppercase tracking-wider">Ficha de Préstamo</span>
                <span class="block text-2xl font-bold">INTERNO</span>
            </div>
        </div>

        <!-- Se eliminó action y method, se agregó el ID para el script -->
        <form id="formularioFicha" class="p-8 space-y-8">
            
            <!-- SECCIÓN 1: Datos de la Obra -->
            <section>
                <h3 class="text-xl font-semibold text-gray-800 border-b pb-2 mb-4">Datos de la Obra</h3>
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="col-span-1">
                        <label class="block text-sm font-medium text-gray-700 mb-1">Clasificación <span class="text-xs text-gray-400 font-normal">(Tomada del lomo del libro)</span></label>
                        <input type="text" name="clasificacion" class="w-full border-gray-300 rounded-md shadow-sm p-2 border focus:outline-none focus:ring-2 focus-ring-jardin" required placeholder="Ej. 779.43I78N">
                    </div>
                    <div class="col-span-1">
            ...
            <!-- SECCIÓN 2: Aportación al Catálogo -->
            <section class="bg-stone-50 p-6 rounded-lg border border-stone-200">
                <div class="flex items-start gap-4">
                    <div class="mt-1">
                        <svg class="w-6 h-6 text-jardin" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 7h.01M7 3h5c.512 0 1.024.195 1.414.586l7 7a2 2 0 010 2.828l-7 7a2 2 0 01-2.828 0l-7-7A1.994 1.994 0 013 12V7a4 4 0 014-4z"></path>
                        </svg>
                    </div>
                    <div class="w-full">
                        <h3 class="text-lg font-semibold text-gray-800">Ayúdanos a enriquecer nuestra biblioteca</h3>
                        <p class="text-sm text-gray-600 mb-3">¿De qué trata este libro? Escribe los temas o palabras clave que, bajo tu criterio, definen esta obra (separados por comas). Esto ayudará a que futuros lectores encuentren la información mucho más rápido.</p>
                        <input type="text" name="tematica_usuario" class="w-full border-gray-300 rounded-md shadow-sm p-3 border focus:outline-none focus:ring-2 focus-ring-jardin" placeholder="Ej. Botánica, Fotografía, Blanco y Negro, Oaxaca...">
                    </div>
                </div>
            </section>

            <!-- SECCIÓN 3: Datos del Lector -->
            <section>
                <h3 class="text-xl font-semibold text-gray-800 border-b pb-2 mb-4">Datos del Lector</h3>
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <div class="col-span-1 md:col-span-2">
                        <label class="block text-sm font-medium text-gray-700 mb-1">Institución de Procedencia</label>
                        <input type="text" name="institucion" class="w-full border-gray-300 rounded-md shadow-sm p-2 border focus:outline-none focus:ring-2 focus-ring-jardin" placeholder="Escuela, Universidad, Organización...">
                    </div>
                    <div class="col-span-1">
            ...
            <section class="pt-4 border-t">
                <div class="flex items-start mb-6">
                    ...
                    <label for="privacidad" class="ms-2 text-sm font-medium text-gray-600">
                        He leído y acepto el <a href="#" class="text-jardin hover:underline">Aviso de Privacidad</a>. Acepto que mis datos, incluido mi número telefónico, sean utilizados exclusivamente para fines estadísticos y de control interno de la biblioteca.
                    </label>
                </div>
    ...
    <script>
        document.getElementById('formularioFicha').addEventListener('submit', async function(e) {
            ...
            try {
                ...
                // Asegúrate de que la ruta coincida con tu archivo Routes.php
